...
def reshape_csv(raw_csv,satellite):
...
def request_noaa_nrt(date=None):
    ...
    filedate = date.strftime('%Y%j')
    file_name = 'J1_VIIRS_C2_SouthEast_Asia_VJ114IMGTDL_NRT_'+ filedate + '.txt'
    url = 'https://nrt4.modaps.eosdis.nasa.gov/api/v2/content/archives/FIRMS/noaa-20-viirs-c2/SouthEast_Asia/' + file_name
    r = requests.get(url , headers={'Authorization':'Bearer '+ token })
    return r
...
def request_suomi_nrt(date=None):
    ...
    filedate = date.strftime('%Y%j')
    file_name = 'SUOMI_VIIRS_C2_SouthEast_Asia_VNP14IMGTDL_NRT_'+ filedate + '.txt'
    url = 'https://nrt4.modaps.eosdis.nasa.gov/api/v2/content/archives/FIRMS/suomi-npp-viirs-c2/SouthEast_Asia/' + file_name
    r = requests.get(url , headers={'Authorization':'Bearer '+ token })
    return r
...
def request_modis_nrt(date=None):
    ...
    filedate = date.strftime('%Y%j')
    file_name = 'MODIS_C6_SouthEast_Asia_MCD14DL_NRT_'+ filedate + '.txt'
    url = 'https://nrt4.modaps.eosdis.nasa.gov/api/v2/content/archives/FIRMS/c6/SouthEast_Asia/' + file_name
    r = requests.get(url , headers={'Authorization':'Bearer '+ token })
    return r